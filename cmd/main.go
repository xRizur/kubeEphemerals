...
func main() {
	...
	var uiAddr string
	var uiPlatformDomain string
	var uiBaseDomain string
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "3043b942.ephemeralenv.io",
	...
	// Start UI server as a manager runnable
	kubeClient, err := kubernetes.NewForConfig(ctrl.GetConfigOrDie())
	if err != nil {
		setupLog.Error(err, "unable to create Kubernetes client for UI server")
		os.Exit(1)
	}
	...
	if err != nil {
		setupLog.Error(err, "unable to create UI server")
		os.Exit(1)
	}
	...
	setupLog.Info("UI server configured", "address", uiAddr)
